...
require_once dirname(dirname(dirname(dirname(__FILE__)))).'/ApkStore/utilities/class.androidaidgroupmanager.php';
...
$groupMgr = new AdndroidAidGroupManager();
...
foreach ($groups as $group){
    $categories = $categoryMgr->getCategoriesByAndroidAidGroup($group['group_serial']);
