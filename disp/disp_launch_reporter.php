...
<form method="post" action="disp_launch_reporter.php">
	<input type="submit" name="order" value="launch_reporter_stamp">

	<input type="submit" name="order" value="device_imei">

	<input type="submit" name="order" value="app_label">
	
	<input type="submit" name="order" value="launch_by_me">
</form>
...
<?php
foreach($ArrayLaunchColumns as $columns){
?>
