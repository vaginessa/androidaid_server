...
<form method="post" action="disp_install_reporter.php">
	<input type="submit" name="order" value="install_reporter_stamp">

	<input type="submit" name="order" value="device_imei">

	<input type="submit" name="order" value="app_label">
	
	<input type="submit" name="order" value="install_action">
</form>
...
<?php
foreach($ArrayInstallColumns as $columns){
?>
