...
#    	echo $this->getAttribute('manifest', 'package');
        return $this->getAttribute('manifest', 'package');
    }
 
    public function getVersionName(){
#    	echo $this->getAttribute('manifest', 'android:versionName');
        return $this->getAttribute('manifest', 'android:versionName');
    }
 
    public function getVersionCode(){
#    	echo $this->getAttribute('manifest', 'android:versionCode');
        return $this->getAttribute('manifest', 'android:versionCode');
    }
 
    public function getAppName(){
#    	echo $this->getAttribute('manifest/application', 'android:name');
