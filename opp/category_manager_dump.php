...
$category_update_stamp =  date("Y-m-d H:i:s");
$api_version = 1;
$array = Array(API_JSON_RESPONSE=>$api_response,API_VERSION=>$api_version,DB_COLUMN_CATEGORY_STAMP=>$category_update_stamp,API_JSON_CATEGORY_ARRAY=>$jsonobj);
echo json_encode($array);

file_put_contents("category_manager.json",json_encode($array));
