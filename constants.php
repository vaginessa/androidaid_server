...
define('DB_TABLE_ACTIVATION_REPORTER', 'activation_reporter');

#database table app_repository
define('DB_COLUMN_ACTIVATION_SERIAL', 'activation_serial');
define('DB_COLUMN_ACTIVATION_DATE', 'activation_date');
define('DB_COLUMN_ACTIVATION_COUNT', 'activation_count');
define('DB_COLUMN_ACTIVATION_UPDATE_STAMP', 'update_stamp');
...
define('DB_VALUE_CATEGORY_IM', '聊天');
define('DB_VALUE_CATEGORY_GAME', '游戏');
define('DB_VALUE_CATEGORY_MUSIC', '音乐');
define('DB_VALUE_CATEGORY_VIDEO', '视频');
define('DB_VALUE_CATEGORY_SHOPPING', '购物');
define('DB_VALUE_CATEGORY_TRANSPORT', '交通');
define('DB_VALUE_CATEGORY_WEATHER', '天气');
define('DB_VALUE_CATEGORY_WEB', '上网');
define('DB_VALUE_CATEGORY_READING', '阅读');
define('DB_VALUE_CATEGORY_TOOLS', '工具');
define('DB_VALUE_CATEGORY_PICTURE', '美图');
define('DB_VALUE_CATEGORY_LIFE', '生活');
define('DB_VALUE_CATEGORY_CAMERA', '摄像');
define('DB_VALUE_CATEGORY_NEWS', '新闻');
...
define('DB_COLUMN_DEVICE_IP', 'device_ip');
define('DB_COLUMN_DEVICE_CITY', 'device_city');
define('DB_COLUMN_DEVICE_PROVINCE', 'device_province');
...
$ArrayDeviceColumns = array(
	...
	DB_COLUMN_DEVICE_IP,
//	DB_COLUMN_DEVICE_CITY,
	DB_COLUMN_DEVICE_PROVINCE,
...
define('DB_COLUMN_LAUNCH_REPORTER_STAMP', 'launch_reporter_stamp');
...
$ArrayLaunchColumns = array(
	...
	DB_COLUMN_LAUNCH_REPORTER_STAMP
	);
